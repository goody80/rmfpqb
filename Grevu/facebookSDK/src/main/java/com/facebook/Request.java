...
public class Request {
     ...
     * @param httpMethod
     *            the {@link com.facebook.HttpMethod} to use for the request, or null for default (HttpMethod.GET)
     */
     ...
     * @return a Request that is ready to execute
     *
     * @throws com.facebook.FacebookException If neither location nor searchText is specified
     */
     ...
     * {@link com.facebook.AppEventsLogger#setLimitEventUsage(android.content.Context, boolean)} with `true` for this user.
     *
     * @param session
    ...
    /**
     * Returns the {@link com.facebook.HttpMethod} to use for this request.
     *
    ...
    /**
     * Sets the {@link com.facebook.HttpMethod} to use for this request.
     *
     * @param httpMethod
     ...
     * {@link com.facebook.Request#executeMeRequestAsync(com.facebook.Session, com.facebook.Request.GraphUserCallback)}
    ...
    /**
     * Specifies the interface that consumers of
     * {@link com.facebook.Request#executeMyFriendsRequestAsync(com.facebook.Session, com.facebook.Request.GraphUserListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
    ...
    /**
     * Specifies the interface that consumers of
     * {@link com.facebook.Request#executePlacesSearchRequestAsync(com.facebook.Session, android.location.Location, int, int, String, com.facebook.Request.GraphPlaceListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
