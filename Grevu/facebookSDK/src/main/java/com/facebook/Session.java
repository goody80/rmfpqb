 ...
 * uses {@link com.facebook.SessionState SessionState} to indicate its state. Once a Session has
...
public class Session implements Serializable {
     ...
     * See {@link com.facebook.SessionState} for details.
     *
     ...
     * the {@link com.facebook.SessionState#CREATED_TOKEN_LOADED CREATED_TOKEN_LOADED}
     ...
     *                    {@link com.facebook.SessionState#CREATED_TOKEN_LOADED CREATED_TOKEN_LOADED} state
     * @throws com.facebook.FacebookException if any publish or manage permissions are requested
     */
     ...
     * @param openRequest the open request, can be null only if the Session is in the
     *                    {@link com.facebook.SessionState#CREATED_TOKEN_LOADED CREATED_TOKEN_LOADED} state
     * @throws com.facebook.FacebookException if the passed in request is null or has no permissions set.
     */
    ...
    public static final class OpenRequest extends AuthorizationRequest {
         ...
         *
         * @param loginBehavior The {@link com.facebook.SessionLoginBehavior SessionLoginBehavior} that
