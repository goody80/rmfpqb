...
public class LoginButton extends Button {
     ...
     * the default ({@link com.facebook.SessionLoginBehavior SessionLoginBehavior.SSO_WITH_FALLBACK}
     * will be used.
     *
     ...
     * will be used.
     *
     * @return loginBehavior The {@link com.facebook.SessionLoginBehavior SessionLoginBehavior} that
     *                      specifies what behaviors should be attempted during
     *                      authorization.
     */
    public SessionLoginBehavior getLoginBehavior() {
     ...
     * @see com.facebook.Session#onActivityResult(android.app.Activity, int, int, android.content.Intent)
     */
